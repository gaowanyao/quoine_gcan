...
rest.prototype.products = function(id,cb){

  if(id == ''){
    return this.make_public_request('products/', cb)
  }else{
    console.log(id);
    return this.make_public_request('products/'+id, cb)
  }

  // return this.make_public_request('products/' + symbol, cb)
}
